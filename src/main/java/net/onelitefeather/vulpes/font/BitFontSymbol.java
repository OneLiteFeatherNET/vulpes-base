...
import net.onelitefeather.vulpes.gson.KeyGsonAdapter;
...
public record BitFontSymbol(
    ...
    private static final Codec<BitFontSymbol, JsonObject, Throwable, Throwable> BIT_FONT_SYMBOL_CODEC = new BitFontSymbol.BitFontSymbolCodec();
